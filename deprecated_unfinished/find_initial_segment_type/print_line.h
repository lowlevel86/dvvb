...
void printLinePattVis3(int x, int y, int offset, int remainder);
void printLinePattVis4(int x, int y, int offset);
void printLinePattVis5(int rise, int run, int offset, int length);
void printLinePattVis6(int rise, int run, int offset, int length);

void printLinePatt2(int rise, int run, int offset, int length);
